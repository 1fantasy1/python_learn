...
# 定义数据预处理函数，将带有单位或逗号分隔的数字转换为整数类型
# def convert_to_int(value):
...
def preprocess_data(data):
    ...
    numeric_cols = ['Subscribers', 'Uploads', 'Views']
    df = df.dropna(subset=numeric_cols)  # 删除 numeric_cols 列中包含 NaN 的行
