...
# 常量定义
MODEL_PATH = 'best_model.keras'  # 模型保存路径
RESULTS_PATH = 'mnist_experiment_results.csv'  # 实验结果保存路径
...
def main():
    ...
    if os.path.exists(MODEL_PATH):
        print("\n检测到已存在训练好的模型")
        print("1. 重新训练所有模型")
        print("2. 直接加载现有模型进行预测")
        choice = input("请选择(默认2): ") or "2"
